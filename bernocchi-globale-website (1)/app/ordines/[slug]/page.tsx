      ...
      <section className="relative isolate min-h-[68svh] overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto flex min-h-[68svh] max-w-7xl flex-col justify-between px-6 py-10 lg:px-10 lg:py-14">
          ...
          <div className="max-w-3xl pb-8">
            ...
            <p className="mt-8 text-[0.66rem] font-semibold uppercase tracking-[0.3em] text-[#c9a85f]">
              {ordo.order}
            </p>
            <h1 className="mt-4 text-balance font-serif text-5xl font-light leading-[0.98] sm:text-6xl lg:text-8xl">
              {ordo.institution}
            </h1>
            <p className="mt-6 max-w-2xl text-balance font-serif text-2xl font-light leading-snug text-[#e4cf9d] sm:text-3xl">
              {ordo.promise}
            </p>
          </div>
        </div>
